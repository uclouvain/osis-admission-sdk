...
class TestPropositionsApi(unittest.TestCase):
    ...
    def test_assent_doctoral_training(self):
        """Test case for assent_doctoral_training
    ...
    def test_destroy_doctoral_training(self):
        """Test case for destroy_doctoral_training
