...
class Communication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, category, type, subtype, title, start_date, is_online, country, city, organizing_institution, website, subtitle, committee, dial_reference, ects, comment, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, category, type, subtype, title, start_date, is_online, country, city, organizing_institution, website, subtitle, committee, dial_reference, ects, comment, *args, **kwargs):  # noqa: E501
        """Communication - a model defined in OpenAPI
