...
class SpecificQuestion(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, type, title, text, help_text, configuration, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, uuid, type, title, text, help_text, configuration, *args, **kwargs):  # noqa: E501
        """SpecificQuestion - a model defined in OpenAPI
