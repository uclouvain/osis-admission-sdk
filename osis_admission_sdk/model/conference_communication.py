...
class ConferenceCommunication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, category, context, type, ects, title, committee, dial_reference, comment, parent, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, category, context, type, ects, title, committee, dial_reference, comment, parent, *args, **kwargs):  # noqa: E501
        """ConferenceCommunication - a model defined in OpenAPI
