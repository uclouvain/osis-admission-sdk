...
class ConferenceCommunication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, ects, title, committee, dial_reference, comment, object_type, category, parent, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, ects, title, committee, dial_reference, comment, object_type, category, parent, *args, **kwargs):  # noqa: E501
        """ConferenceCommunication - a model defined in OpenAPI
