...
class Course(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, title, subtitle, organizing_institution, start_date, end_date, hour_volume, authors, ects, comment, object_type, category, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, title, subtitle, organizing_institution, start_date, end_date, hour_volume, authors, ects, comment, object_type, category, *args, **kwargs):  # noqa: E501
        """Course - a model defined in OpenAPI
