...
class ExperienceOutput(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'curriculum_year': (ExperienceOutputCurriculumYear,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, country, curriculum_year, type, *args, **kwargs):  # noqa: E501
        """ExperienceOutput - a model defined in OpenAPI

        Args:
            country (str, none_type):
            curriculum_year (ExperienceOutputCurriculumYear):
            type (ExperienceType):
    ...
    @convert_js_args_to_python_args
    def __init__(self, country, curriculum_year, type, *args, **kwargs):  # noqa: E501
        """ExperienceOutput - a model defined in OpenAPI
