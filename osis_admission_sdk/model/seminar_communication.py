...
class SeminarCommunication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, start_date, is_online, country, city, organizing_institution, website, authors, comment, object_type, category, parent, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, start_date, is_online, country, city, organizing_institution, website, authors, comment, object_type, category, parent, *args, **kwargs):  # noqa: E501
        """SeminarCommunication - a model defined in OpenAPI
