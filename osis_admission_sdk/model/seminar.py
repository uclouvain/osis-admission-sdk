...
class Seminar(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, category, context, type, title, start_date, end_date, hour_volume, ects, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, category, context, type, title, start_date, end_date, hour_volume, ects, *args, **kwargs):  # noqa: E501
        """Seminar - a model defined in OpenAPI
