...
class Publication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, category, context, type, title, start_date, authors, role, keywords, journal, publication_status, dial_reference, ects, comment, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, category, context, type, title, start_date, authors, role, keywords, journal, publication_status, dial_reference, ects, comment, *args, **kwargs):  # noqa: E501
        """Publication - a model defined in OpenAPI
