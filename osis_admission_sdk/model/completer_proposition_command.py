...
class CompleterPropositionCommand(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'bureau_cde': (str, none_type,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, uuid, type_admission, documents_projet, graphe_gantt, proposition_programme_doctoral, projet_formation_complementaire, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            bureau_cde (str, none_type): [optional]  # noqa: E501
            ...
            langue_redaction_these (str): [optional] if omitted the server will use the default value of "UNDECIDED"  # noqa: E501
            doctorat_deja_realise (str): [optional] if omitted the server will use the default value of "NO"  # noqa: E501
