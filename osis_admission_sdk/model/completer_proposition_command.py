...
class CompleterPropositionCommand(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, type_admission, bureau_cde, documents_projet, graphe_gantt, proposition_programme_doctoral, projet_formation_complementaire, lettres_recommandation, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, uuid, type_admission, bureau_cde, documents_projet, graphe_gantt, proposition_programme_doctoral, projet_formation_complementaire, lettres_recommandation, *args, **kwargs):  # noqa: E501
        """CompleterPropositionCommand - a model defined in OpenAPI
