...
class Conference(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, category, context, type, ects, title, start_date, end_date, participating_days, is_online, website, country, city, organizing_institution, comment, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, category, context, type, ects, title, start_date, end_date, participating_days, is_online, website, country, city, organizing_institution, comment, *args, **kwargs):  # noqa: E501
        """Conference - a model defined in OpenAPI
