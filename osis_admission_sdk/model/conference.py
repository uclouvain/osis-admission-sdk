...
class Conference(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, ects, title, start_date, end_date, participating_days, is_online, website, country, city, organizing_institution, comment, object_type, category, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, ects, title, start_date, end_date, participating_days, is_online, website, country, city, organizing_institution, comment, object_type, category, *args, **kwargs):  # noqa: E501
        """Conference - a model defined in OpenAPI
