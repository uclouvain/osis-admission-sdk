...
class PropositionDTO(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, type_admission, reference, doctorat, matricule_candidat, code_secteur_formation, documents_projet, graphe_gantt, proposition_programme_doctoral, projet_formation_complementaire, lettres_recommandation, langue_redaction_these, lieu_these, doctorat_deja_realise, fiche_archive_signatures_envoyees, statut, erreurs, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, uuid, type_admission, reference, doctorat, matricule_candidat, code_secteur_formation, documents_projet, graphe_gantt, proposition_programme_doctoral, projet_formation_complementaire, lettres_recommandation, langue_redaction_these, lieu_these, doctorat_deja_realise, fiche_archive_signatures_envoyees, statut, erreurs, *args, **kwargs):  # noqa: E501
        """PropositionDTO - a model defined in OpenAPI
