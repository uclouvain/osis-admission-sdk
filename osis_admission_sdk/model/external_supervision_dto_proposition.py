...
class ExternalSupervisionDTOProposition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, type_admission, reference, doctorat, matricule_candidat, code_secteur_formation, domaine_these, fiche_archive_signatures_envoyees, statut, *args, **kwargs):  # noqa: E501
        """ExternalSupervisionDTOProposition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, uuid, type_admission, reference, doctorat, matricule_candidat, code_secteur_formation, domaine_these, fiche_archive_signatures_envoyees, statut, *args, **kwargs):  # noqa: E501
        """ExternalSupervisionDTOProposition - a model defined in OpenAPI
