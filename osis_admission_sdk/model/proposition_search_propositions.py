...
class PropositionSearchPropositions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, reference, type_admission, sigle_doctorat, intitule_doctorat_fr, intitule_doctorat_en, matricule_candidat, code_secteur_formation, intitule_secteur_formation, creee_le, statut, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, uuid, reference, type_admission, sigle_doctorat, intitule_doctorat_fr, intitule_doctorat_en, matricule_candidat, code_secteur_formation, intitule_secteur_formation, creee_le, statut, *args, **kwargs):  # noqa: E501
        """PropositionSearchPropositions - a model defined in OpenAPI
