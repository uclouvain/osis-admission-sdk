...
class DocumentSpecificQuestionsListImmediateRequestedDocuments(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'uuid': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
            'title': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'text': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'help_text': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, type, title, text, help_text, configuration, values, tab, tab_name, required, *args, **kwargs):  # noqa: E501
        """DocumentSpecificQuestionsListImmediateRequestedDocuments - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, uuid, type, title, text, help_text, configuration, values, tab, tab_name, required, *args, **kwargs):  # noqa: E501
        """DocumentSpecificQuestionsListImmediateRequestedDocuments - a model defined in OpenAPI
