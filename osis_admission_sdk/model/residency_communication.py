...
class ResidencyCommunication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, subtype, title, start_date, is_online, organizing_institution, website, subtitle, ects, comment, object_type, category, parent, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, subtype, title, start_date, is_online, organizing_institution, website, subtitle, ects, comment, object_type, category, parent, *args, **kwargs):  # noqa: E501
        """ResidencyCommunication - a model defined in OpenAPI
