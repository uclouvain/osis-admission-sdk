...
class ResidencyCommunication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, category, context, type, subtype, title, start_date, is_online, organizing_institution, website, subtitle, ects, comment, parent, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, category, context, type, subtype, title, start_date, is_online, organizing_institution, website, subtitle, ects, comment, parent, *args, **kwargs):  # noqa: E501
        """ResidencyCommunication - a model defined in OpenAPI
