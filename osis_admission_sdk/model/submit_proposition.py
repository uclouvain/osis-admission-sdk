...
class SubmitProposition(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'annee': (int,),  # noqa: E501
            'pool': (str,),  # noqa: E501
            'elements_confirmation': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, annee, pool, elements_confirmation, *args, **kwargs):  # noqa: E501
        """SubmitProposition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, annee, pool, elements_confirmation, *args, **kwargs):  # noqa: E501
        """SubmitProposition - a model defined in OpenAPI
