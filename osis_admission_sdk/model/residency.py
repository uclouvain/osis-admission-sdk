...
class Residency(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, category, context, type, ects, subtitle, start_date, end_date, country, city, comment, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, category, context, type, ects, subtitle, start_date, end_date, country, city, comment, *args, **kwargs):  # noqa: E501
        """Residency - a model defined in OpenAPI
