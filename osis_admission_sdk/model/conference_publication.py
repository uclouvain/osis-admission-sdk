...
class ConferencePublication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, category, type, ects, title, authors, role, keywords, committee, journal, dial_reference, comment, parent, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, category, type, ects, title, authors, role, keywords, committee, journal, dial_reference, comment, parent, *args, **kwargs):  # noqa: E501
        """ConferencePublication - a model defined in OpenAPI
