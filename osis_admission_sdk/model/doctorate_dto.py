...
class DoctorateDTO(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, reference, statut, sigle_formation, annee_formation, intitule_formation, type_admission, titre_these, type_financement, matricule_doctorant, noma_doctorant, genre_doctorant, prenom_doctorant, nom_doctorant, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, uuid, reference, statut, sigle_formation, annee_formation, intitule_formation, type_admission, titre_these, type_financement, matricule_doctorant, noma_doctorant, genre_doctorant, prenom_doctorant, nom_doctorant, *args, **kwargs):  # noqa: E501
        """DoctorateDTO - a model defined in OpenAPI
