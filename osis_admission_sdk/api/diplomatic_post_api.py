...
class DiplomaticPostApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_diplomatic_post_endpoint = _Endpoint(
            settings={
                'response_type': (DiplomaticPost,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/diplomatic-post/{code}',
                'operation_id': 'retrieve_diplomatic_post',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def retrieve_diplomatic_post(
        self,
        code,
        **kwargs
    ):
        """retrieve_diplomatic_post  # noqa: E501

        Retrieves a diplomatic post  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.retrieve_diplomatic_post(code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['code'] = \
            code
        return self.retrieve_diplomatic_post_endpoint.call_with_http_info(**kwargs)
