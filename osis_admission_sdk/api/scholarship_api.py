...
class ScholarshipApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_scholarship_endpoint = _Endpoint(
            settings={
                'response_type': (Scholarship,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/scholarship/{uuid}',
                'operation_id': 'retrieve_scholarship',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def retrieve_scholarship(
        self,
        uuid,
        **kwargs
    ):
        """retrieve_scholarship  # noqa: E501

        Retrieves a scholarship  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.retrieve_scholarship(uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['uuid'] = \
            uuid
        return self.retrieve_scholarship_endpoint.call_with_http_info(**kwargs)
