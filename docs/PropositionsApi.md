...
[**pay_application_fees_after_request**](PropositionsApi.md#pay_application_fees_after_request) | **POST** /propositions/general-education/{uuid}/pay-application-fees-after-request | 
[**pay_application_fees_after_submission**](PropositionsApi.md#pay_application_fees_after_submission) | **POST** /propositions/general-education/{uuid}/pay-application-fees | 
...
# **pay_application_fees_after_request**
> PropositionIdentityDTO pay_application_fees_after_request(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    x_user_email = "X-User-Email_example" # str |  (optional)
    x_user_global_id = "X-User-GlobalID_example" # str |  (optional)
    payer_frais_dossier_proposition_suite_demande_command = PayerFraisDossierPropositionSuiteDemandeCommand(
        uuid_proposition="uuid_proposition_example",
    ) # PayerFraisDossierPropositionSuiteDemandeCommand |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.pay_application_fees_after_request(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->pay_application_fees_after_request: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.pay_application_fees_after_request(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, payer_frais_dossier_proposition_suite_demande_command=payer_frais_dossier_proposition_suite_demande_command)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->pay_application_fees_after_request: %s\n" % e)
```
 ...
 **x_user_email** | **str**|  | [optional]
 **x_user_global_id** | **str**|  | [optional]
 **payer_frais_dossier_proposition_suite_demande_command** | [**PayerFraisDossierPropositionSuiteDemandeCommand**](PayerFraisDossierPropositionSuiteDemandeCommand.md)|  | [optional]
...
# **pay_application_fees_after_submission**
> PropositionIdentityDTO pay_application_fees_after_submission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    x_user_email = "X-User-Email_example" # str |  (optional)
    x_user_global_id = "X-User-GlobalID_example" # str |  (optional)
    payer_frais_dossier_proposition_suite_soumission_command = PayerFraisDossierPropositionSuiteSoumissionCommand(
        uuid_proposition="uuid_proposition_example",
    ) # PayerFraisDossierPropositionSuiteSoumissionCommand |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.pay_application_fees_after_submission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->pay_application_fees_after_submission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.pay_application_fees_after_submission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, payer_frais_dossier_proposition_suite_soumission_command=payer_frais_dossier_proposition_suite_soumission_command)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->pay_application_fees_after_submission: %s\n" % e)
```
 ...
 **x_user_email** | **str**|  | [optional]
 **x_user_global_id** | **str**|  | [optional]
 **payer_frais_dossier_proposition_suite_soumission_command** | [**PayerFraisDossierPropositionSuiteSoumissionCommand**](PayerFraisDossierPropositionSuiteSoumissionCommand.md)|  | [optional]
