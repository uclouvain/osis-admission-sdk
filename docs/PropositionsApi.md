...
[**approve_by_pdf**](PropositionsApi.md#approve_by_pdf) | **POST** /propositions/{uuid}/supervision/approve-by-pdf | 
[**approve_proposition**](PropositionsApi.md#approve_proposition) | **POST** /propositions/{uuid}/supervision/approve | 
[**assent_doctoral_training**](PropositionsApi.md#assent_doctoral_training) | **POST** /propositions/{uuid}/training/{activity_id}/assent | 
...
[**create_doctoral_training**](PropositionsApi.md#create_doctoral_training) | **POST** /propositions/{uuid}/training | 
[**create_proposition**](PropositionsApi.md#create_proposition) | **POST** /propositions | 
[**create_signatures**](PropositionsApi.md#create_signatures) | **POST** /propositions/{uuid}/supervision/request-signatures | 
[**destroy_doctoral_training**](PropositionsApi.md#destroy_doctoral_training) | **DELETE** /propositions/{uuid}/training/{activity_id} | 
[**destroy_proposition**](PropositionsApi.md#destroy_proposition) | **DELETE** /propositions/{uuid} | 
[**list_doctoral_trainings**](PropositionsApi.md#list_doctoral_trainings) | **GET** /propositions/{uuid}/training | 
...
[**reject_proposition**](PropositionsApi.md#reject_proposition) | **PUT** /propositions/{uuid}/supervision/approve | 
[**remove_member**](PropositionsApi.md#remove_member) | **POST** /propositions/{uuid}/supervision | 
[**retrieve_accounting**](PropositionsApi.md#retrieve_accounting) | **GET** /propositions/{uuid}/accounting | 
...
[**retrieve_doctoral_training**](PropositionsApi.md#retrieve_doctoral_training) | **GET** /propositions/{uuid}/training/{activity_id} | 
[**retrieve_doctoral_training_config**](PropositionsApi.md#retrieve_doctoral_training_config) | **GET** /propositions/{uuid}/training/config | 
...
[**set_reference_promoter**](PropositionsApi.md#set_reference_promoter) | **PUT** /propositions/{uuid}/supervision/set-reference-promoter | 
...
[**submit_doctoral_training**](PropositionsApi.md#submit_doctoral_training) | **POST** /propositions/{uuid}/training/submit | 
[**submit_proposition**](PropositionsApi.md#submit_proposition) | **POST** /propositions/{uuid}/submit | 
[**update_accounting**](PropositionsApi.md#update_accounting) | **PUT** /propositions/{uuid}/accounting | 
[**update_cotutelle**](PropositionsApi.md#update_cotutelle) | **PUT** /propositions/{uuid}/cotutelle | 
[**update_doctoral_training**](PropositionsApi.md#update_doctoral_training) | **PUT** /propositions/{uuid}/training/{activity_id} | 
...
# **assent_doctoral_training**
> DoctoralTrainingAssent assent_doctoral_training(uuid, activity_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.assent_doctoral_training(uuid, activity_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->assent_doctoral_training: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.assent_doctoral_training(uuid, activity_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, doctoral_training_assent=doctoral_training_assent)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->assent_doctoral_training: %s\n" % e)
```
...
# **destroy_doctoral_training**
> destroy_doctoral_training(uuid, activity_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_instance.destroy_doctoral_training(uuid, activity_id)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->destroy_doctoral_training: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_instance.destroy_doctoral_training(uuid, activity_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->destroy_doctoral_training: %s\n" % e)
```
...
# **list_doctoral_trainings**
> [DoctoralTrainingActivity] list_doctoral_trainings(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.list_doctoral_trainings(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->list_doctoral_trainings: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.list_doctoral_trainings(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->list_doctoral_trainings: %s\n" % e)
```
...
> DoctoralTrainingActivity retrieve_doctoral_training(uuid, activity_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_doctoral_training(uuid, activity_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->retrieve_doctoral_training: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_doctoral_training(uuid, activity_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->retrieve_doctoral_training: %s\n" % e)
```
...
# **submit_doctoral_training**
> DoctoralTrainingBatch submit_doctoral_training(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.submit_doctoral_training(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->submit_doctoral_training: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.submit_doctoral_training(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, doctoral_training_batch=doctoral_training_batch)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->submit_doctoral_training: %s\n" % e)
```
...
# **update_doctoral_training**
> DoctoralTrainingActivity update_doctoral_training(uuid, activity_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_doctoral_training(uuid, activity_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->update_doctoral_training: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_doctoral_training(uuid, activity_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, doctoral_training_activity=doctoral_training_activity)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PropositionsApi->update_doctoral_training: %s\n" % e)
```
