...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    coordonnees = Coordonnees(
        ...
        private_email="private_email_example",
        phone_mobile="phone_mobile_example",
        emergency_contact_phone="emergency_contact_phone_example",
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    high_school_diploma = HighSchoolDiploma(
        graduated_from_high_school=GotDiploma(""),
        graduated_from_high_school_year=1,
        ...
        foreign_diploma=HighSchoolDiplomaForeignDiploma(
            ...
            final_equivalence_decision_ue=[
                "final_equivalence_decision_ue_example",
            ],
            final_equivalence_decision_not_ue=[
                "final_equivalence_decision_not_ue_example",
            ],
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    person_identification = PersonIdentification(
        ...
        id_card_expiry_date=dateutil_parser('1970-01-01').date(),
        passport_expiry_date=dateutil_parser('1970-01-01').date(),
