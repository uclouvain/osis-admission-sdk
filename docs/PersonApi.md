...
[**retrieve_curriculum_admission**](PersonApi.md#retrieve_curriculum_admission) | **GET** /propositions/doctorate/{uuid}/curriculum/ | 
[**retrieve_curriculum_continuing_education_admission**](PersonApi.md#retrieve_curriculum_continuing_education_admission) | **GET** /propositions/continuing-education/{uuid}/curriculum/ | 
[**retrieve_curriculum_file**](PersonApi.md#retrieve_curriculum_file) | **GET** /curriculum/file | 
[**retrieve_curriculum_file_admission**](PersonApi.md#retrieve_curriculum_file_admission) | **GET** /propositions/doctorate/{uuid}/curriculum/file | 
[**retrieve_curriculum_file_continuing_education_admission**](PersonApi.md#retrieve_curriculum_file_continuing_education_admission) | **GET** /propositions/continuing-education/{uuid}/curriculum/file | 
[**retrieve_curriculum_file_general_education_admission**](PersonApi.md#retrieve_curriculum_file_general_education_admission) | **GET** /propositions/general-education/{uuid}/curriculum/file | 
[**retrieve_curriculum_general_education_admission**](PersonApi.md#retrieve_curriculum_general_education_admission) | **GET** /propositions/general-education/{uuid}/curriculum/ | 
...
[**update_curriculum_file_admission**](PersonApi.md#update_curriculum_file_admission) | **PUT** /propositions/doctorate/{uuid}/curriculum/file | 
[**update_curriculum_file_continuing_education_admission**](PersonApi.md#update_curriculum_file_continuing_education_admission) | **PUT** /propositions/continuing-education/{uuid}/curriculum/file | 
[**update_curriculum_file_general_education_admission**](PersonApi.md#update_curriculum_file_general_education_admission) | **PUT** /propositions/general-education/{uuid}/curriculum/file | 
...
# **retrieve_curriculum_continuing_education_admission**
> Curriculum retrieve_curriculum_continuing_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_curriculum_continuing_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_curriculum_continuing_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_continuing_education_admission: %s\n" % e)
```
...
# **retrieve_curriculum_file_continuing_education_admission**
> CurriculumFile retrieve_curriculum_file_continuing_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_curriculum_file_continuing_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_file_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_curriculum_file_continuing_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_file_continuing_education_admission: %s\n" % e)
```
...
# **retrieve_curriculum_file_general_education_admission**
> CurriculumFile retrieve_curriculum_file_general_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_curriculum_file_general_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_file_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_curriculum_file_general_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_file_general_education_admission: %s\n" % e)
```
...
# **retrieve_curriculum_general_education_admission**
> Curriculum retrieve_curriculum_general_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_curriculum_general_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_curriculum_general_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_general_education_admission: %s\n" % e)
```
...
# **update_curriculum_file_continuing_education_admission**
> CurriculumFile update_curriculum_file_continuing_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_curriculum_file_continuing_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_file_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_curriculum_file_continuing_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, curriculum_file=curriculum_file)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_file_continuing_education_admission: %s\n" % e)
```
...
# **update_curriculum_file_general_education_admission**
> CurriculumFile update_curriculum_file_general_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_curriculum_file_general_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_file_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_curriculum_file_general_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, curriculum_file=curriculum_file)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_file_general_education_admission: %s\n" % e)
```
