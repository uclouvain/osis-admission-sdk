...
[**retrieve_curriculum_details_admission**](PersonApi.md#retrieve_curriculum_details_admission) | **GET** /propositions/doctorate/{uuid}/curriculum | 
...
[**update_continuing_education_completer_curriculum_command_admission**](PersonApi.md#update_continuing_education_completer_curriculum_command_admission) | **PUT** /propositions/continuing-education/{uuid}/complete-curriculum | 
...
[**update_doctorat_completer_curriculum_command_admission**](PersonApi.md#update_doctorat_completer_curriculum_command_admission) | **PUT** /propositions/doctorate/{uuid}/complete-curriculum | 
...
[**update_educational_experience_continuing_education_admission**](PersonApi.md#update_educational_experience_continuing_education_admission) | **PUT** /propositions/continuing-education/{uuid}/curriculum/educational/{experience_id} | 
...
[**update_general_education_completer_curriculum_command_admission**](PersonApi.md#update_general_education_completer_curriculum_command_admission) | **PUT** /propositions/general-education/{uuid}/complete-curriculum | 
...
# **retrieve_coordonnees_general_education_admission**
> Coordonnees retrieve_coordonnees_general_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_coordonnees_general_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_coordonnees_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_coordonnees_general_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_coordonnees_general_education_admission: %s\n" % e)
```
...
# **retrieve_curriculum_details**
> CurriculumDetails retrieve_curriculum_details()
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.retrieve_curriculum_details(accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_details: %s\n" % e)
```
...
[**CurriculumDetails**](CurriculumDetails.md)
...
# **retrieve_curriculum_details_admission**
> CurriculumDetails retrieve_curriculum_details_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_curriculum_details_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_details_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_curriculum_details_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_details_admission: %s\n" % e)
```
...
# **retrieve_curriculum_details_continuing_education_admission**
> CurriculumDetails retrieve_curriculum_details_continuing_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_curriculum_details_continuing_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_details_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_curriculum_details_continuing_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_details_continuing_education_admission: %s\n" % e)
```
...
# **retrieve_curriculum_details_general_education_admission**
> CurriculumDetails retrieve_curriculum_details_general_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_curriculum_details_general_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_details_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_curriculum_details_general_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_details_general_education_admission: %s\n" % e)
```
...
# **retrieve_educational_experience_continuing_education_admission**
> EducationalExperience retrieve_educational_experience_continuing_education_admission(uuid, experience_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_educational_experience_continuing_education_admission(uuid, experience_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_educational_experience_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_educational_experience_continuing_education_admission(uuid, experience_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_educational_experience_continuing_education_admission: %s\n" % e)
```
...
# **retrieve_educational_experience_general_education_admission**
> EducationalExperience retrieve_educational_experience_general_education_admission(uuid, experience_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_educational_experience_general_education_admission(uuid, experience_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_educational_experience_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_educational_experience_general_education_admission(uuid, experience_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_educational_experience_general_education_admission: %s\n" % e)
```
...
# **retrieve_high_school_diploma_continuing_education_admission**
> HighSchoolDiploma retrieve_high_school_diploma_continuing_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_high_school_diploma_continuing_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_high_school_diploma_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_high_school_diploma_continuing_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_high_school_diploma_continuing_education_admission: %s\n" % e)
```
...
# **retrieve_high_school_diploma_general_education_admission**
> HighSchoolDiploma retrieve_high_school_diploma_general_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_high_school_diploma_general_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_high_school_diploma_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_high_school_diploma_general_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_high_school_diploma_general_education_admission: %s\n" % e)
```
...
# **retrieve_person_identification_continuing_education_admission**
> PersonIdentification retrieve_person_identification_continuing_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_person_identification_continuing_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_person_identification_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_person_identification_continuing_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_person_identification_continuing_education_admission: %s\n" % e)
```
...
# **retrieve_person_identification_general_education_admission**
> PersonIdentification retrieve_person_identification_general_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_person_identification_general_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_person_identification_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_person_identification_general_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_person_identification_general_education_admission: %s\n" % e)
```
...
# **retrieve_professional_experience_continuing_education_admission**
> ProfessionalExperience retrieve_professional_experience_continuing_education_admission(uuid, experience_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_professional_experience_continuing_education_admission(uuid, experience_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_professional_experience_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_professional_experience_continuing_education_admission(uuid, experience_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_professional_experience_continuing_education_admission: %s\n" % e)
```
...
# **retrieve_professional_experience_general_education_admission**
> ProfessionalExperience retrieve_professional_experience_general_education_admission(uuid, experience_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_professional_experience_general_education_admission(uuid, experience_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_professional_experience_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_professional_experience_general_education_admission(uuid, experience_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_professional_experience_general_education_admission: %s\n" % e)
```
...
# **update_continuing_education_completer_curriculum_command_admission**
> ContinuingEducationCompleterCurriculumCommand update_continuing_education_completer_curriculum_command_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    x_user_email = "X-User-Email_example" # str |  (optional)
    x_user_global_id = "X-User-GlobalID_example" # str |  (optional)
    continuing_education_completer_curriculum_command = ContinuingEducationCompleterCurriculumCommand(
        uuid_proposition="uuid_proposition_example",
        curriculum=[
            "curriculum_example",
        ],
        equivalence_diplome=[
            "equivalence_diplome_example",
        ],
        reponses_questions_specifiques={},
    ) # ContinuingEducationCompleterCurriculumCommand |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_continuing_education_completer_curriculum_command_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_continuing_education_completer_curriculum_command_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_continuing_education_completer_curriculum_command_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, continuing_education_completer_curriculum_command=continuing_education_completer_curriculum_command)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_continuing_education_completer_curriculum_command_admission: %s\n" % e)
```
 ...
 **x_user_email** | **str**|  | [optional]
 **x_user_global_id** | **str**|  | [optional]
 **continuing_education_completer_curriculum_command** | [**ContinuingEducationCompleterCurriculumCommand**](ContinuingEducationCompleterCurriculumCommand.md)|  | [optional]

### Return type

[**ContinuingEducationCompleterCurriculumCommand**](ContinuingEducationCompleterCurriculumCommand.md)
...
# **update_coordonnees_continuing_education_admission**
> Coordonnees update_coordonnees_continuing_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_coordonnees_continuing_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_coordonnees_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_coordonnees_continuing_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, coordonnees=coordonnees)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_coordonnees_continuing_education_admission: %s\n" % e)
```
...
# **update_coordonnees_general_education_admission**
> Coordonnees update_coordonnees_general_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_coordonnees_general_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_coordonnees_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_coordonnees_general_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, coordonnees=coordonnees)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_coordonnees_general_education_admission: %s\n" % e)
```
...
# **update_doctorat_completer_curriculum_command_admission**
> DoctoratCompleterCurriculumCommand update_doctorat_completer_curriculum_command_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    x_user_email = "X-User-Email_example" # str |  (optional)
    x_user_global_id = "X-User-GlobalID_example" # str |  (optional)
    doctorat_completer_curriculum_command = DoctoratCompleterCurriculumCommand(
        uuid_proposition="uuid_proposition_example",
        curriculum=[
            "curriculum_example",
        ],
        reponses_questions_specifiques={},
    ) # DoctoratCompleterCurriculumCommand |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_doctorat_completer_curriculum_command_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_doctorat_completer_curriculum_command_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_doctorat_completer_curriculum_command_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, doctorat_completer_curriculum_command=doctorat_completer_curriculum_command)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_doctorat_completer_curriculum_command_admission: %s\n" % e)
```
 ...
 **x_user_email** | **str**|  | [optional]
 **x_user_global_id** | **str**|  | [optional]
 **doctorat_completer_curriculum_command** | [**DoctoratCompleterCurriculumCommand**](DoctoratCompleterCurriculumCommand.md)|  | [optional]

### Return type

[**DoctoratCompleterCurriculumCommand**](DoctoratCompleterCurriculumCommand.md)
...
# **update_educational_experience_continuing_education_admission**
> EducationalExperience update_educational_experience_continuing_education_admission(uuid, experience_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_educational_experience_continuing_education_admission(uuid, experience_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_educational_experience_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_educational_experience_continuing_education_admission(uuid, experience_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, educational_experience=educational_experience)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_educational_experience_continuing_education_admission: %s\n" % e)
```
...
# **update_educational_experience_general_education_admission**
> EducationalExperience update_educational_experience_general_education_admission(uuid, experience_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_educational_experience_general_education_admission(uuid, experience_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_educational_experience_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_educational_experience_general_education_admission(uuid, experience_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, educational_experience=educational_experience)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_educational_experience_general_education_admission: %s\n" % e)
```
...
# **update_general_education_completer_curriculum_command_admission**
> GeneralEducationCompleterCurriculumCommand update_general_education_completer_curriculum_command_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    x_user_email = "X-User-Email_example" # str |  (optional)
    x_user_global_id = "X-User-GlobalID_example" # str |  (optional)
    general_education_completer_curriculum_command = GeneralEducationCompleterCurriculumCommand(
        uuid_proposition="uuid_proposition_example",
        continuation_cycle_bachelier=True,
        attestation_continuation_cycle_bachelier=[
            "attestation_continuation_cycle_bachelier_example",
        ],
        curriculum=[
            "curriculum_example",
        ],
        ...
        reponses_questions_specifiques={},
    ) # GeneralEducationCompleterCurriculumCommand |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_general_education_completer_curriculum_command_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_general_education_completer_curriculum_command_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_general_education_completer_curriculum_command_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, general_education_completer_curriculum_command=general_education_completer_curriculum_command)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_general_education_completer_curriculum_command_admission: %s\n" % e)
```
 ...
 **x_user_email** | **str**|  | [optional]
 **x_user_global_id** | **str**|  | [optional]
 **general_education_completer_curriculum_command** | [**GeneralEducationCompleterCurriculumCommand**](GeneralEducationCompleterCurriculumCommand.md)|  | [optional]

### Return type

[**GeneralEducationCompleterCurriculumCommand**](GeneralEducationCompleterCurriculumCommand.md)
...
# **update_high_school_diploma_continuing_education_admission**
> HighSchoolDiploma update_high_school_diploma_continuing_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_high_school_diploma_continuing_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_high_school_diploma_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_high_school_diploma_continuing_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, high_school_diploma=high_school_diploma)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_high_school_diploma_continuing_education_admission: %s\n" % e)
```
...
# **update_high_school_diploma_general_education_admission**
> HighSchoolDiploma update_high_school_diploma_general_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_high_school_diploma_general_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_high_school_diploma_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_high_school_diploma_general_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, high_school_diploma=high_school_diploma)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_high_school_diploma_general_education_admission: %s\n" % e)
```
...
# **update_person_identification_continuing_education_admission**
> PersonIdentification update_person_identification_continuing_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_person_identification_continuing_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_person_identification_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_person_identification_continuing_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, person_identification=person_identification)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_person_identification_continuing_education_admission: %s\n" % e)
```
...
# **update_person_identification_general_education_admission**
> PersonIdentification update_person_identification_general_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_person_identification_general_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_person_identification_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_person_identification_general_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, person_identification=person_identification)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_person_identification_general_education_admission: %s\n" % e)
```
...
# **update_professional_experience_continuing_education_admission**
> ProfessionalExperience update_professional_experience_continuing_education_admission(uuid, experience_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_professional_experience_continuing_education_admission(uuid, experience_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_professional_experience_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_professional_experience_continuing_education_admission(uuid, experience_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, professional_experience=professional_experience)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_professional_experience_continuing_education_admission: %s\n" % e)
```
...
# **update_professional_experience_general_education_admission**
> ProfessionalExperience update_professional_experience_general_education_admission(uuid, experience_id)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_professional_experience_general_education_admission(uuid, experience_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_professional_experience_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_professional_experience_general_education_admission(uuid, experience_id, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, professional_experience=professional_experience)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_professional_experience_general_education_admission: %s\n" % e)
```
