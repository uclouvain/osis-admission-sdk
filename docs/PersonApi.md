...
[**update_curriculum**](PersonApi.md#update_curriculum) | **PUT** /curriculum | 
[**update_curriculum_admission**](PersonApi.md#update_curriculum_admission) | **PUT** /propositions/doctorate/{uuid}/curriculum | 
[**update_curriculum_continuing_education_admission**](PersonApi.md#update_curriculum_continuing_education_admission) | **PUT** /propositions/continuing-education/{uuid}/curriculum | 
[**update_curriculum_general_education_admission**](PersonApi.md#update_curriculum_general_education_admission) | **PUT** /propositions/general-education/{uuid}/curriculum | 
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.update_curriculum(accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, curriculum=curriculum)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum: %s\n" % e)
```
 ...
 **x_user_email** | **str**|  | [optional]
 **x_user_global_id** | **str**|  | [optional]
 **curriculum** | [**Curriculum**](Curriculum.md)|  | [optional]
...
# **update_curriculum_admission**
> Curriculum update_curriculum_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_curriculum_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_curriculum_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, curriculum=curriculum)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_admission: %s\n" % e)
```
...
# **update_curriculum_continuing_education_admission**
> Curriculum update_curriculum_continuing_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_curriculum_continuing_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_continuing_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_curriculum_continuing_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, curriculum=curriculum)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_continuing_education_admission: %s\n" % e)
```
...
# **update_curriculum_general_education_admission**
> Curriculum update_curriculum_general_education_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_curriculum_general_education_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_general_education_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_curriculum_general_education_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, curriculum=curriculum)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_general_education_admission: %s\n" % e)
```
