...
------------- | ------------- | -------------
[**create_curriculum_experience**](PersonApi.md#create_curriculum_experience) | **POST** /curriculum | 
[**create_curriculum_experience_admission**](PersonApi.md#create_curriculum_experience_admission) | **POST** /propositions/{uuid}/curriculum | 
...
[**destroy_curriculum_experience**](PersonApi.md#destroy_curriculum_experience) | **DELETE** /curriculum/{xp} | 
[**destroy_curriculum_experience_admission**](PersonApi.md#destroy_curriculum_experience_admission) | **DELETE** /propositions/{uuid}/curriculum/{xp} | 
[**list_curriculum_experiences**](PersonApi.md#list_curriculum_experiences) | **GET** /curriculum | 
[**list_curriculum_experiences_admission**](PersonApi.md#list_curriculum_experiences_admission) | **GET** /propositions/{uuid}/curriculum | 
...
[**retrieve_curriculum_experience**](PersonApi.md#retrieve_curriculum_experience) | **GET** /curriculum/{xp} | 
[**retrieve_curriculum_experience_admission**](PersonApi.md#retrieve_curriculum_experience_admission) | **GET** /propositions/{uuid}/curriculum/{xp} | 
...
[**update_curriculum_experience**](PersonApi.md#update_curriculum_experience) | **PUT** /curriculum/{xp} | 
[**update_curriculum_experience_admission**](PersonApi.md#update_curriculum_experience_admission) | **PUT** /propositions/{uuid}/curriculum/{xp} | 
...
# **create_curriculum_experience**
> ExperienceOutput create_curriculum_experience()
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    experience_input = ExperienceInput(
        ...
        academic_year=1,
        type=ExperienceType("HIGHER_EDUCATION"),
        institute_name="institute_name_example",
        institute_city="institute_city_example",
        institute_postal_code="institute_postal_code_example",
        education_name="education_name_example",
        result=Result(""),
        graduation_year=True,
        obtained_grade=Grade(""),
        rank_in_diploma="rank_in_diploma_example",
        issue_diploma_date=dateutil_parser('1970-01-01').date(),
        credit_type=CreditType(""),
        entered_credits_number=0,
        acquired_credits_number=0,
        transcript=[
            "transcript_example",
        ],
        graduate_degree=[
        ...
        access_certificate_after_60_master=[
            "access_certificate_after_60_master_example",
        ],
        ...
        belgian_education_community=BelgianCommunitiesOfEducation(""),
        study_system=StudySystem(""),
        study_cycle_type=ForeignStudyCycleType(""),
        ...
        other_activity_type="other_activity_type_example",
        activity_certificate=[
            "activity_certificate_example",
        ],
        activity_position="activity_position_example",
        curriculum_year=1,
        institute=1,
        program=1,
    ) # ExperienceInput |  (optional)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.create_curriculum_experience(accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, experience_input=experience_input)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->create_curriculum_experience: %s\n" % e)
```
 ...
 **experience_input** | [**ExperienceInput**](ExperienceInput.md)|  | [optional]

### Return type

[**ExperienceOutput**](ExperienceOutput.md)
...
# **create_curriculum_experience_admission**
> ExperienceOutput create_curriculum_experience_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.create_curriculum_experience_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->create_curriculum_experience_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.create_curriculum_experience_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, experience_input=experience_input)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->create_curriculum_experience_admission: %s\n" % e)
```
...
# **destroy_curriculum_experience**
> bool, date, datetime, dict, float, int, list, str, none_type destroy_curriculum_experience(xp)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.destroy_curriculum_experience(xp)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->destroy_curriculum_experience: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.destroy_curriculum_experience(xp, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->destroy_curriculum_experience: %s\n" % e)
```
...
# **destroy_curriculum_experience_admission**
> bool, date, datetime, dict, float, int, list, str, none_type destroy_curriculum_experience_admission(uuid, xp)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.destroy_curriculum_experience_admission(uuid, xp)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->destroy_curriculum_experience_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.destroy_curriculum_experience_admission(uuid, xp, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->destroy_curriculum_experience_admission: %s\n" % e)
```
...
# **list_curriculum_experiences**
> [ExperienceOutput] list_curriculum_experiences()
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.list_curriculum_experiences(accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->list_curriculum_experiences: %s\n" % e)
```
...
# **list_curriculum_experiences_admission**
> [ExperienceOutput] list_curriculum_experiences_admission(uuid)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.list_curriculum_experiences_admission(uuid)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->list_curriculum_experiences_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.list_curriculum_experiences_admission(uuid, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->list_curriculum_experiences_admission: %s\n" % e)
```
...
# **retrieve_curriculum_experience**
> ExperienceOutput retrieve_curriculum_experience(xp)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_curriculum_experience(xp)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_experience: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_curriculum_experience(xp, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_experience: %s\n" % e)
```
...
# **retrieve_curriculum_experience_admission**
> ExperienceOutput retrieve_curriculum_experience_admission(uuid, xp)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.retrieve_curriculum_experience_admission(uuid, xp)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_experience_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.retrieve_curriculum_experience_admission(uuid, xp, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->retrieve_curriculum_experience_admission: %s\n" % e)
```
...
# **update_curriculum_experience**
> ExperienceOutput update_curriculum_experience(xp)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_curriculum_experience(xp)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_experience: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_curriculum_experience(xp, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, experience_input=experience_input)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_experience: %s\n" % e)
```
...
# **update_curriculum_experience_admission**
> ExperienceOutput update_curriculum_experience_admission(uuid, xp)
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.update_curriculum_experience_admission(uuid, xp)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_experience_admission: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.update_curriculum_experience_admission(uuid, xp, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, experience_input=experience_input)
        pprint(api_response)
    except osis_admission_sdk.ApiException as e:
        print("Exception when calling PersonApi->update_curriculum_experience_admission: %s\n" % e)
```
    ...
    high_school_diploma = HighSchoolDiploma(
        ...
        foreign_diploma=HighSchoolDiplomaForeignDiploma(
            ...
            restrictive_equivalence_daes=[
                "restrictive_equivalence_daes_example",
            ],
            restrictive_equivalence_admission_test=[
                "restrictive_equivalence_admission_test_example",
            ],
        ),
