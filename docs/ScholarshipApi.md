# osis_admission_sdk.ScholarshipApi

All URIs are relative to *https://dev.osis.uclouvain.be/api/v1/admission*

Method | HTTP request | Description
------------- | ------------- | -------------
[**retrieve_scholarship**](ScholarshipApi.md#retrieve_scholarship) | **GET** /scholarship/{uuid} | 
...
from osis_admission_sdk.api import scholarship_api
...
with osis_admission_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = scholarship_api.ScholarshipApi(api_client)
    ...
    try:
        ...
        print("Exception when calling ScholarshipApi->retrieve_scholarship: %s\n" % e)
